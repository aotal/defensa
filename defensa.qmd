...
::: notes
Hablar de que el ICRU89 es el documento heredero de las recomendaciones de GEC-ESTRO. Recordar el trabajo del grupo de la SEFM
:::
...
::: notes
Solamente imagen en 3D. Aunque los US son una modalidad prometedora no es la estándar.
:::
...
::: notes
Hablar también del tiempo de exploración.Artefactos de movimiento no.
:::
...
::: notes
Hablar de la disponibilidad. Modalidad de imagen para la zona pélvica.
:::
...
::: notes
Se aprecia el cérvix, en el CT no. Aumento del volumen segmentado. Dificulad en la BT adaptativa con CT.
:::
...
::: notes
Colocamos las posiciones de la fuente sobre la imagen. Manualmente o por otros métodos.
:::
...
::: notes
Hechas de materiales con "hidrógenos"(Por la resonancia) Al ser líquidos, problemas de contrucción de dummies de canal. De ahí la dificultad para las agujas.
:::
...
::: notes
Colocamos el Template mediante las bolas. En CT se ve el template perfectamente, no en el caso de la MRI.
:::
...
::: notes
Varian lo tiene pero no he trabajado con el sistema. Aunque seguro que está diseñado de una manera parecida.
:::
...
```
::: notes
Explicar muy por encima el algebra de transformaciones. Recordar que se han desarrollado mucho los cálculos algebraicos sobre sistemas informáticos. AI.
:::
...
::: notes
Nodos y transiciones. Las transiciones las transformaciones. Los nodos las piezas.
:::
...
::: notes
Hubo que crear una aguja. Utilizamos el concepto del free-length
:::
